...
urlpatterns = [
    ...
    path("painel/mapa-anuncios/", views.marketplace_map_listings_view, name="painel_mapa"),
    ...
    path("gestor/categorias/<uuid:category_id>/remover/", views.admin_category_delete_view, name="gestor_categoria_remover"),
